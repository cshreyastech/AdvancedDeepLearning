...
def create_model():
    ...
    model.add(Dense(30, init='normal', activation='tanh', W_constraint=maxnorm(3)))
    model.add(Dropout(0.25))
    model.add(Dense(15, init='normal', activation='tanh', W_constraint=maxnorm(3)))
...
estimators.append(('mlp', KerasClassifier(build_fn=create_model, nb_epoch=100, batch_size=16, verbose=0)))
